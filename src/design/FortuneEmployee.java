...
public class FortuneEmployee {
	...
	public static void main(String[] args) throws Exception {
		...
		EmployeeInfo employee1 = new EmployeeInfo("Leonardo Dicaprio", 222100);
		EmployeeInfo employee2 = new EmployeeInfo("Olivia Wilde", 222101);
		EmployeeInfo employee3 = new EmployeeInfo("Emily Blunt", 222102);
		EmployeeInfo employee4 = new EmployeeInfo("Michael Fassbender", 222103);
		EmployeeInfo employee5 = new EmployeeInfo("James Mccavoy", 222104);
